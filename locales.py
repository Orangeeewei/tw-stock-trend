...
UI = {
    "zh": {
        ...
        "s3_hint": "條件:熱門產業 + 漲幅落後同業 + 離高點還有空間 + 已出現甦醒跡象。為了視野全面,同一產業最多收錄數檔,其他強勢產業的機會才看得到。進場分數越高,代表「產業對、{mid}位置對」同時成立的程度越高。<b>70 分以上才值得認真研究。</b>點股票名稱可開啟完整技術圖。",
