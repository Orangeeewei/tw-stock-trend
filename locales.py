...
UI = {
    "zh": {
        ...
        "s3_bear_warn": "⚠️ <b>大盤翻空(跌破 60 日線)</b>:2 年回測顯示,補漲策略在空頭時優勢完全消失——連 70+ 候選也只有約 25% 勝率、平均輸大盤 4.9%。強烈建議減碼或觀望,寧可錯過,不要做錯。",
    ...
    "en": {
        ...
        "s3_bear_warn": "⚠️ <b>Market turned bearish (below 60-day MA)</b>: historically the catch-up strategy's win rate drops sharply in downtrends — candidates are scarce and tend to keep lagging. Consider trimming or staying on the sidelines.",
