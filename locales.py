...
UI = {
    "zh": {
        ...
        "s2_note": "📈 <b>2 年回測:領頭羊整體小幅贏大盤</b>(多頭時 10 日約 +0.9%、20 日 +0.5% 超額),且比補漲(③)穩。回測還發現:<b>漲最兇的反而會回檔</b>(動能 IC 負),真正預測續強的是<b>法人買超</b>(投信 IC +0.08)——故本清單已改用<b>投信近 5 日買超排序</b>(法人挺的擺前面),別追噴最大的。屬右尾(命中不到半、少數大贏);高信心逐檔進場仍以補漲候選(③ ≥70 分)為主。",
        ...
        "s3_bear_warn": "⚠️ <b>大盤翻空(跌破 60 日線)</b>:2 年回測顯示,補漲策略在空頭時優勢完全消失——連 70+ 候選也只有約 25% 勝率、平均輸大盤 4.9%。強烈建議減碼或觀望,寧可錯過,不要做錯。清單已收合,點開自負風險。",
        "s3_bear_us": "⚠️ <b>大盤跌破 60 日線、趨勢轉弱</b>:補漲策略順勢才有利,空頭時風險升高。清單已收合,點開自負風險。",
        ...
        "s4_hint": "5/10/20 個交易日前的<b>補漲候選</b>(高分優先)與<b>領頭羊</b>,至今的實際報酬 vs 同期大盤。這一區是系統的成績單。註:領頭羊不是用 0~100 分挑的(它看近新高、強過同業、法人買超),故「當時分數」欄顯示「—」,屬正常。",
        "s4_cols": ["回顧", "股票", "當時分數", "當時收盤", "最新收盤", "至今報酬", "平均 vs 大盤"],
        "s4_ago": "{n} 天前", "s4_market": "大盤", "s4_beat": "贏大盤", "s4_lose": "輸大盤",
        "s4_kind": {"laggard": "補漲", "leader": "領頭羊"},
        ...
        "s5_bull_only": " · 僅計大盤多頭日(空頭時策略失效,見補漲區警示)",
    ...
    "en": {
        ...
        "s2_note": "📈 <b>2-year backtest: leaders modestly beat the index overall</b> (~+0.9% over 10 days, +0.5% over 20 in bull markets), and steadier than the catch-up names (③). The backtest also found: <b>the hottest names revert</b> (momentum IC negative), while what actually predicts continuation is <b>institutional buying</b> (trust IC +0.08) — so this list is now <b>ranked by 5-day institutional net buying</b> (institution-backed names first). Don't chase the biggest movers. It's a right-tail (win rate under half, a few big winners); high-conviction entries still come from the catch-up candidates (③, 70+).", "days_unit": "{n}d",
        ...
        "s3_bear_warn": "⚠️ <b>Market turned bearish (below 60-day MA)</b>: a 2-year backtest shows the catch-up edge vanishes in downtrends — even 70+ candidates win only ~25% and lag the index by ~4.9% on average. Strongly consider trimming or waiting. The list is collapsed — expand at your own risk.",
        "s3_bear_us": "⚠️ <b>Index below its 60-day MA — trend weakening</b>: catch-up setups only work with the trend; risk is elevated in downtrends. The list is collapsed — expand at your own risk.",
        ...
        "s4_hint": "<b>Catch-up candidates</b> (high-score first) and <b>leaders</b> from 5/10/20 trading days ago, with returns since vs the index. This is the system's report card. Note: leaders aren't picked by a 0–100 score (they're near highs, beating peers, with institutional buying), so their “score then” column shows “—” — that's normal.",
        ...
        "s4_kind": {"laggard": "Catch-up", "leader": "Leader"},
