...
UI = {
    "zh": {
        ...
        "s3_top_tag": "🔥強推",
        "s3_top_line": "🔥 <b>今日強推</b>(80 分以上;回測:大盤多頭時歷史命中約 64%、20 日平均超額 +10.7%):{names}",
        "s3_top_none": "今日無 80 分以上的強推標的。可續觀察 70+ 候選(歷史命中約 55%);門檻越高、歷史勝率越高,寧缺勿濫。",
        "s3_bear_warn": "⚠️ <b>大盤翻空(跌破 60 日線)</b>:補漲策略歷史上在空頭時勝率大降、候選稀少且常續弱,建議減碼或觀望——寧可錯過,不要做錯。",
